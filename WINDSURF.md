# Windsurf Development Workflow Rules

このファイルは、Windsurfを使用した開発ワークフローの標準手順を定義します。
...
- **Windsurf Cascade、MCPサーバーを積極的に活用**して動作確認を徹底する
...
4. **Phase 4: Planning** - Windsurf TodoListで計画立案
5. **Phase 5: Implementation** - Windsurf Cascadeでコード実装
